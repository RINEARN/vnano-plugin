...
public class LengthXfci1PluginTest {
	...
	public void testDoubleScalar() {
		...
		dimDataContainer.setData(new long[] { 0L }, 0, ArrayDataAccessorInterface1.SCALAR_LENGTHS);
		outputDataContainer.setData(new long[] { 0L }, 0, ArrayDataAccessorInterface1.SCALAR_LENGTHS);
	...
	public void testDoubleArray2D() throws ConnectorException {
		...
		// 演算を実行（次元インデックス: 1）
		dimDataContainer.setData(new long[] { 1L }, 0, ArrayDataAccessorInterface1.SCALAR_LENGTHS);
		function.invoke(new Object[]{ outputDataContainer, inputDataContainer, dimDataContainer });
