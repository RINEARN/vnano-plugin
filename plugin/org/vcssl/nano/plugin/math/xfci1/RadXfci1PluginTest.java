...
public class RadXfci1PluginTest {
	...
	public void testDoubleScalar() throws ConnectorException {
		...
		inputDataContainer.setData(new double[] { 180.0 }, 0, ArrayDataAccessorInterface1.SCALAR_LENGTHS);
	...
	public void testDoubleArrayElement() throws ConnectorException {
		...
		inputDataContainer.setData(new double[] { 180.0, 360.0, 720.0 }, inputDataOffset, ArrayDataAccessorInterface1.SCALAR_LENGTHS);
