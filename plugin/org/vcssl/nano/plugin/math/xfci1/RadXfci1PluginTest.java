...
public class RadXfci1PluginTest {
	...
	public void testDoubleScalar() throws ConnectorException {
		...
		inputDataContainer.setData(new double[] { 180.0 }, 0, ArrayDataContainerInterface1.SCALAR_LENGTHS);
	...
	public void testDoubleArray1D() throws ConnectorException {
		...
		inputDataContainer.setData(new double[] { 180.0, 90.0, 60.0 }, 0, inputArrayLengths);
	...
	public void testDoubleArray2D() throws ConnectorException {
		...
		inputDataContainer.setData(new double[] { 360.0, 270.0, 180.0, 90.0, 60.0, 30.0 }, 0, inputArrayLengths);
	...
	public void testDoubleArrayElement() throws ConnectorException {
		...
		inputDataContainer.setData(new double[] { 180.0, 360.0, 720.0 }, inputDataOffset, ArrayDataContainerInterface1.SCALAR_LENGTHS);
