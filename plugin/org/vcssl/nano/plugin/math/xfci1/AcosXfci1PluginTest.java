...
public class AcosXfci1PluginTest {
	...
	public void testDoubleScalar() throws ConnectorException {
		...
		inputDataContainer.setData(new double[] { 0.123 }, 0, ArrayDataAccessorInterface1.SCALAR_LENGTHS);
	...
	public void testDoubleArrayElement() throws ConnectorException {
		...
		inputDataContainer.setData(new double[] { 0.1, 0.2, 0.3 }, inputDataOffset, ArrayDataAccessorInterface1.SCALAR_LENGTHS);
