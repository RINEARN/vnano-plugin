...
public class PowXfci1PluginTest {
	...
	public void testSettings() {
		ExternalFunctionConnectorInterface1 function = new PowXfci1Plugin();
	...
	public void testDoubleScalar() throws ConnectorException {
		...
		exponentDataContainer.setData(new double[] { 2.3 }, 0, ArrayDataContainerInterface1.SCALAR_LENGTHS);
	...
	public void testDoubleArrayElement() throws ConnectorException {
		...
		exponentDataContainer.setData(new double[] { 1.1, 2.3, 3.6 }, 1, ArrayDataContainerInterface1.SCALAR_LENGTHS);
